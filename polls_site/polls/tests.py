...
class QuestionMethodTests(TestCase):
    ...
    def test_was_published_recently_with_future_date(self):
        """
        was published recently should return False for questions whose pub_date is in the future
        :return:
        """
...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_a_future_question(self):
        """
        Questions with a pub_date in teh future should not be displayed on the index page
        """
...
class QuestionIndexDetailTests(TestCase):
    ...
    def test_detail_view_with_a_past_quest(self):
        """
